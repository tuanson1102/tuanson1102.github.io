...
public class Repository {
    ...
    public void sortProductByCategory(){
        ...
        System.out.println("nhập danh mục bạn chọn: ");
        String category = sc.nextLine();
        listProducts.stream()
        .filter(product -> product.getCategory().toString().toLowerCase().contains(category))
        .forEach(product -> System.out.println(product));
    }
    public void sortProductByAmountSale(){
            listProducts.sort(new Comparator<Product>(){
                ...
                @Override
                 public int compare(Product o1, Product o2) {
                    return (int) ((int) o1.getAmountSale() - o2.getAmountSale());
                 }
                
            });
        //listProducts.sort((o1, o2) -> (int)o1.getAmountSale().compareTo((int)o2.getAmountSale()));
    }
    public void maxProductByAmountSale(){
        listProducts.sort(new Comparator<Product>(){
